...
[左側の裏を写した写真](images/IMG_0218.jpeg) [右側の裏を写した写真](images/IMG_0215.jpeg)(マイコンボード故障でリカバリ箇所あり)
* OLED、TRRSジャックはつけない。リチウムイオン充電池を両面テープで貼り付け、プラス線は BAT+ につなぐ。マイナス線からは BAT- につなぐ途中にリセッタブルヒューズと電源スイッチを入れる。
* 左右間通信はBluetoothで行う。
